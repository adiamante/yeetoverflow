...
{
    public class YeetColumnValuesConverter : MarkupExtension, IMultiValueConverter
    {
        static YeetColumnValuesConverter _converter = new YeetColumnValuesConverter();
        public object Convert(object[] values, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            if (values.Length >= 2 && values[0] is YeetTableControl && values[1] is String)
            {
                ...
                return ytc.Table.GetColumnValuesView(colName);
            }
            return null;
        }
